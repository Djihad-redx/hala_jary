            ...
            Column(
              children: [
                ...
                Container(
                  ...
                  child: Row(children: [
                    Flexible(child: InputField(controller: _signUpController.firstNameController.value,hint: "First name", icon: "ic_person",divider: true,)),
                    Flexible(child: Container(margin:EdgeInsets.only(left: 10,right: 10),child: InputField(controller:_signUpController.lastNameController.value,hint: "Last name", icon: "",divider: false,)))
                  ],),
                ),
                ...
                Container(
                  ...
                  child: InternationalPhoneNumberInput(
                    ...
                    selectorTextStyle: TextStyle(color: Colors.black),
                     initialValue: number,
                    textFieldController: _signUpController.phoneNumberController.value,
                    hintText: "581019255",
                    formatInput: false,
                    keyboardType: TextInputType.numberWithOptions(signed: true, decimal: true),
                    onSaved: (PhoneNumber numberr) {
                      print('On Saved: $numberr');
                      //  number = numberr;
                    },
                  ),
                ),
                ...
                Container(
                    ...
                    child: InputField(
                      ...
                      hint: "Email", icon: "ic_Email",divider: true,)),
                SizedBox(height: getHight(context)*.02,),
                Container(
                  margin:EdgeInsets.symmetric(horizontal: 40),
                  height: 48,
                  ...
                  child: Row(children: [
                    ...
                    InkWell(
                      onTap: (){
                        _signUpController.updateGender();
                      },
                      child: Padding(
                        ...
                        child: Container(height: 12,width: 12,decoration: BoxDecoration(
                          ...
                          color: _signUpController.genderRememberMe.value == "male"?Colors.black:Colors.white
                        ),),
                      ),
                    ),
                    ...
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Container(height: 12,width: 12,decoration: BoxDecoration(
                            border: Border.all(color: HINT_COLOR,width: 2),
                            shape: BoxShape.circle,
                            color: _signUpController.genderRememberMe.value == "female"?Colors.black:Colors.white
                ...
                Container(
                  ...
                  child: CheckboxListTile(
                    ...
                    value: _signUpController.isAgreeTermsConditions.value,
                    onChanged: (newValue) {
                      _signUpController.isAgreeTermsConditions(newValue);
                    },
                ...
                InkWell(
                    ...
                    child: Container(margin:EdgeInsets.symmetric(horizontal: 40),child: MyButton(text: "SIGN UP", width: MediaQuery.of(context).size.width, background_color: Colors.black, border_radius: 10, hight: 60, text_color: Colors.white, text_size: 17))),
                SizedBox(height: getHight(context)*.03,),
                Row(
